<?php if ( ! defined( 'ABSPATH' ) ) exit;
	/**
		...
		*
		* @package     Wow_Login_Pro_ADMIN_LINKS
		* @subpackage  
	...
	*/
	...
	class Wow_Login_ADMIN_LINKS {
		...
		public function row_meta( $meta, $plugin_file ){
			...
			return $meta;
			$meta[] = '<a href="https://wow-estore.com/item/wow-login-pro/" target="_blank">Pro version</a> | <a href="https://www.facebook.com/wowaffect/" target="_blank">Join us on Facebook</a>';
			return $meta;
		}
