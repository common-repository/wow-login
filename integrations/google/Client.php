...
require_once $this->plugin_dir.'integrations/google/Auth/AssertionCredentials.php';
require_once $this->plugin_dir.'integrations/google/Cache/File.php';
require_once $this->plugin_dir.'integrations/google/Cache/Memcache.php';
require_once $this->plugin_dir.'integrations/google/Config.php';
require_once $this->plugin_dir.'integrations/google/Collection.php';
require_once $this->plugin_dir.'integrations/google/Exception.php';
require_once $this->plugin_dir.'integrations/google/IO/Curl.php';
require_once $this->plugin_dir.'integrations/google/IO/Stream.php';
require_once $this->plugin_dir.'integrations/google/Model.php';
require_once $this->plugin_dir.'integrations/google/Service.php';
require_once $this->plugin_dir.'integrations/google/Service/Resource.php';
